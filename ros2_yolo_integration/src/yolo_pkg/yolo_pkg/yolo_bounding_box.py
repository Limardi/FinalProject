...
class YoloBoundingBox:
    def __init__(self, image_processor, load_params):
        ...
        self._cache_ttl = 0.040  # reuse result if called again within 40 ms
    ...
    def get_tags_and_boxes(self, confidence_threshold=None):
        ...
        # Return cached result if called again within the same frame window.
        # This prevents YOLO running 3x per loop iteration (camera_geometry +
        # draw_bounding_boxes + _draw_object_offsets all call this method).
        ...
        self._cache_result = detected_objects
